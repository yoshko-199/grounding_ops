...
Supersedes [v0.3](claim-verification-engine.v0.3.md), [v0.2](claim-verification-engine.v0.2.md) and [v0.1](claim-verification-engine.v0.1.md). Companion documents: [Acceptance Criteria](acceptance-criteria.md), [Custodian Pack Interface](custodian-pack-interface.md).

---

## 0a. What changed in v0.4
